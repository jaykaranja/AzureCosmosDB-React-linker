The code above contains all the main functionalities required to manage an Azure CosmosDB resource that can be run from a ReactJS application. All credit goes to the author of the code, and Microsoft.
